...
'''/************************************************************/
		AUTHOR=wilson andres salgado quiceno
		incio = octibre 15 2015
		fin = noviembre 11 2015
        total = 10000 horas
	/************************************************************/'''
...
if user == 12:  # numero 12
    ...
    if usr == 2:
        ...
        if (unum1 == unum2) or (unum1 == dnum1) or (unum1 == dnum2) or (unum2 == unum1) or (unum2 == dnum1) or (
                    unum2 == dnum2) or (dnum1 == unum2) or (dnum1 == unum1) or (dnum1 == dnum2) or (dnum2 == unum2) or (
                    dnum2 == dnum1) or (dnum2 == unum2):
...
if user == 36:  # numero 36
    os.system("clear")
    print("-------------numero 36-------------")
    print(" Leer un número entero de 4 dígitos y determinar si tiene mas dígitos pares o impares.")
    # CODE
    num1 = int(input("pon un numero }}==> "))
    u = int(num1 % 10)
    d = int((num1 / 10) % 10)
    ...
    if (um % 2) == 0:
        ...
        impar += 1
    print("pares : ", par, "inpares :", impar)
    if par > impar:
        print("tiene mas digitos pares que inpares: ", par)
    else:
        if par < impar:
            print("tiene mas inpares que pares: ", impar)
        else:
            if par == impar:
                print("los pares y los inpares son iguales")
...
if user == 37:  # numero 37
    os.system("clear")
    print("-------------numero 37-------------")
    print(" Leer dos números enteros y determinar cuál es múltiplo de cuál.")
    # CODE
    num1 = int(input("pon el primer digito }}==> "))
    num2 = int(input("pon el segundo digito }}==> "))
    if (num1 % num2) == 0:
        print("el numero1 es multiplo de del segundo")
    else:
        if (num2 % num1) == 0:
            print("el segundo numero es multiplo del primero")
        else:
            print("los numeros notiene multiplos en comun")
...
if user == 38:  # numero 38 ##############################################obligatorio
    os.system("clear")
    print("-------------numero 38-------------")
    print(". Leer tres números enteros y determinar si el último dígito de los tres números es igual.")

    # CODE
    num1 = int(input("el primer numero : "))
    num2 = int(input("el segundo numero : "))
    num3 = int(input("el tercero numero : "))
    d1 = num1 % 10
    d2 = num2 % 10
    d3 = num3 % 10
    if d1 == d2 and d2 == d3:
        ...
        print("lso digitos no son iguales")
    input("Presiona enter para continuar... ")
    os.system("python taller.py")
...
if user == 39:  # numero 39
    os.system("clear")
    print("-------------numero 39-------------")
    print(" Leer tres números enteros y determina si el penúltimo dígito de los tres números es igual.")
    # CODE
    num1 = int(input("el primer numero : "))
    num2 = int(input("el segundo numero : "))
    num3 = int(input("el tercero numero : "))
    ...
    d3 = int((num3 / 10) % 10)
    if d1 == d2 and d2 == d3:
        print("los penultimso digitos son iguales")
    else:
        print("lso digitos no son iguales")
    input("Presiona enter para continuar... ")
    os.system("python taller.py")
...
if user == 40:  # numero 40
    ...
    print("-------------numero 40-------------")
    print(
        " Leer dos números enteros y si la diferencia entre los dos es menor o igual a 10 entonces mostrar en pantalla todos los enteros comprendidos entre el menor y el mayor de los númerosleídos.")
    # CODE
    num1 = int(input("el primer numero : "))
    num2 = int(input("el segundo numero : "))
    if num1 - num2 <= 10:
